...
// или components/WebDesignPage.tsx
      ...
      <article className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <section className="mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            ...
            або утвърдена средна компания, ние имаме решението за вас.
          </p>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={step.num} className="flex items-start bg-white border-l-4 border-blue-600 p-6 rounded-r-lg shadow-md">
